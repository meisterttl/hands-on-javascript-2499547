...
const buildImage = (imgData) => {
  ...
  if (imgData.urls.regular) srcset += `${imgData.urls.full} ${imgData.width}w,`;
  if (imgData.urls.regular) srcset += `, ${imgData.urls.regular} 1080w,`;
  if (imgData.urls.small) srcset += `, ${imgData.urls.small} 400w`;
